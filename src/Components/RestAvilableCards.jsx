...
import { CLOUD_URL } from "./utilis";

const RestAvilableCards = (props) => {
  const { resdata } = props;
  ...
  return (
    <>
      ...
      <div>
        <div>
          <h2>Restaurants Avilable in Benuluru</h2>
        </div>
        <div
          key={resdata?.info?.id}
          className="w-[200px] h-[300px] cursor-pointer bg-gray-300 mx-2 rounded-md transition duration-300 ease-in-out transform hover:shadow-lg"
        >
...
export default RestAvilableCards;
